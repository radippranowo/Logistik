    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Merk</h4>
            </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" wire:model="kode_merk" class="form-control">
                                    @error('kode_merk') <span class="text-danger small">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-12 mb-3">
                                    <label>Nama Merk</label>
                                    <input type="text" wire:model="nama_merk" class="form-control">
                                    @error('nama_merk') <span class="text-danger small">{{ $message }}</span> @enderror
                                </div>
                            </div>
                        </div>
